...
public class WinningScreenController implements Initializable {
    ...
    public void getRow() {
        ...
        File anotherFile = new File(System.getProperty("user.home") + "/tictactoe","history.txt");
        try {
            fileOutputStream = new FileOutputStream(anotherFile);
        ...
        try {
         ...
         Path path = Paths.get(System.getProperty("user.home") + "/tictactoe/"+"history.txt");
            try {
                Files.write(path, arr, StandardOpenOption.APPEND);
            } catch (IOException ex) {
