 ...
 * @author SOHA
 */
public class PlayRecordTwoController implements Initializable {
    ...
    private void getStepsData(int gameId) {
        try {
            BufferedReader read = new BufferedReader(new FileReader(new File("src/SystemFile/RecordStepTwo.txt")));
            String line;
